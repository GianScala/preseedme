...
export default function RocketIco(props: Props) {
  return (
    <svg
      viewBox="0 0 15 15"
      ...
      {...props}
    >
      <path d="M12.5547,1c-2.1441,0-5.0211,1.471-6.9531,4H4
        ...
        M10,4c0.5523,0,1,0.4477,1,1
        c0,0.5523-0.4477,1-1,1C9.4477,6,9,5.5523,9,5C9,4.4477,9.4477,4,10,4z 
