...
export async function POST(request: Request) {
  try {
    ...
    const preheader = "Please verify your email address to secure your PreseedMe account.";
                    ...
                    <tr>
                      <td style="padding: 10px 40px 40px; text-align: center;">
                        ...
                        <p style="margin: 0 0 32px; color: #a1a1aa; font-size: 15px; line-height: 1.6;">
                          Hey <strong style="color: #ffffff;">${username}</strong>, thanks for joining! Please click the button below to verify your account and start connecting.
                        </p>

                        <table width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center">
                              <a href="${verificationLink}" style="display: inline-block; padding: 16px 36px; background-color: #21DDC0; color: #000000; text-decoration: none; font-weight: 700; font-size: 15px; border-radius: 8px; transition: all 0.2s ease;">
                                Verify My Account
                              </a>
                            </td>
                          </tr>
